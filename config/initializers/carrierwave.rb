...
CarrierWave.configure do |config|
  ...
  config.fog_credentials = {
    provider: 'AWS',
    aws_access_key_id: Rails.application.credentials.digital_ocean[:aws_access_key_id],
    aws_secret_access_key: Rails.application.credentials.digital_ocean[:aws_secret_access_key],
    region: 'nyc3',
