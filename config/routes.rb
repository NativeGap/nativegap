...
Rails.application.routes.draw do
  scope protocol: (Rails.env.production? ? 'https' : 'http') do
    ...
    constraints subdomain: '' do
      ...
      resources :subscriptions, path: 'billing', only: [:index, :create, :update, :destroy]
      get 'checkout', to: 'subscriptions#new', constraints: Modalist::Ajax.new
      post 'stripe/webhook', to: 'subscriptions#stripe_webhook'
      namespace :users, path: '' do
        get 'payment-method', to: 'payment_methods#show', constraints: Modalist::Ajax.new
        get 'payment-method/add', to: 'payment_methods#edit', as: :edit_payment_method, constraints: Modalist::Ajax.new
      ...
      resources :apps, path: 'dashboard', except: [:new] do
        namespace :apps, path: '' do
          ...
          get 'builds/:id/version', to: 'builds#version', as: :version, constraints: Modalist::Ajax.new
          get 'builds/:id/key', to: 'builds#key', as: :key, constraints: Modalist::Ajax.new
          get 'builds/:id/splash-screen', to: 'builds#splash_screen', as: :splash_screen, constraints: Modalist::Ajax.new
        end
      end
      ...
      get 'explore/:id/install', to: 'explore#install', as: :install_app_explore, constraints: Modalist::Ajax.new
